...
// There is the Renderable that supports being loaded and drawn in a location, and  on the other end of the spectrum there is the animation that can control how it draws its sub components.
package render
